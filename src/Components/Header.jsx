...
const Header = () => (
  <header>
    <nav class="navbar navbar-light px-5" style={{ backgroundColor: "#0B4040" }}>
      <div class="container-fluid">
        ...
        <section>
          <Button backgroundColor="#ACF2EB" value="Registrarse" />
          <Button backgroundColor="#A7F2CF" value="Iniciar Sesión" />
        </section>
      </div>
    </nav>
  </header>
